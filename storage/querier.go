...
type Querier interface {
	...
	GetSessionPlaceGivenVenue(ctx context.Context, arg GetSessionPlaceGivenVenueParams) (*models.SessionPlacesGivenVenue, error)
	GetSessionPlaceGivenVenueFromSessionPlace(ctx context.Context, sessionPlaceID uint64) (*models.SessionPlacesGivenVenue, error)
	GetSessionPlaceMemberHome(ctx context.Context, arg GetSessionPlaceMemberHomeParams) (*models.SessionPlacesMemberHome, error)
	GetSessionPlaceMemberHomeFromSessionPlace(ctx context.Context, sessionPlaceID uint64) (*models.SessionPlacesMemberHome, error)
	GetSessionPlaceOnline(ctx context.Context, arg GetSessionPlaceOnlineParams) (*models.SessionPlacesOnline, error)
	GetSessionPlaceOnlineFromSessionPlace(ctx context.Context, sessionPlaceID uint64) (*models.SessionPlacesOnline, error)
	UpdateSessionPlaceOnline(ctx context.Context, arg UpdateSessionPlaceOnlineParams) (*models.SessionPlacesOnline, error)
	UpdateSessionPlaceGivenVenue(ctx context.Context, arg UpdateSessionPlaceGivenVenueParams) (*models.SessionPlacesGivenVenue, error)
	// Membership
...
type QuerierTx interface {
	...
	ChangeSessionPlaceTx(ctx context.Context, arg ChangeSessionPlaceParams) (models.ISessionPlace, error)
	// Members of session
