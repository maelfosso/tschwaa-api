...
type Querier interface {
	...
	GetSessionPlaceGiveVenue(ctx context.Context, arg GetSessionPlaceGiveVenueParams) (*models.SessionPlacesGivenVenue, error)
	GetSessionPlaceGiveVenueFromSessionPlace(ctx context.Context, sessionPlaceID uint64) (*models.SessionPlacesGivenVenue, error)
